...
if utils.settings.get_replace_rocket() then
    ...
    utils.technologies.replace_recipe_unlock("captivity", "capture-robot-rocket", "capture-robot-capsule")
    ...
    utils.technologies.add_recipe_unlock("captivity", "capture-robot-capsule", 1)
end
